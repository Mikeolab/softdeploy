...
-- This script creates all necessary tables and policies for project isolation
...
CREATE TABLE IF NOT EXISTS projects (
  ...
  environment TEXT DEFAULT 'production' CHECK (environment IN ('development', 'production', 'staging')),
